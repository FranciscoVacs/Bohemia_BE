...
export class EventGalleryController extends BaseController<EventGallery> {
    constructor(protected model: IEventGalleryModel<EventGallery>, private eventModel: EventModel) {
        super(model);
    }
    ...
    uploadImages = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
        ...
        uploadMiddleware(req, res, async (err: any) => {
            ...
            for (const file of files) {
                ...
                } as RequiredEntityData<EventGallery>;
